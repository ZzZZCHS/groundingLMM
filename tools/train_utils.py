...
from tools.dataset import SequenceDataset, R2D2Dataset, MetaDataset
...
VAL_ENV_INFOS = torch.load("/ailab/user/huanghaifeng/work/robocasa_exps_haifeng/robocasa/datasets/v0.1/generated_1013/val_env_infos.pt", map_location="cpu")
